...
class DocumentTest : public testing::Test {
  protected:
    virtual void SetUp() {
        const control_block_t lControlBlock = { false, false, "./data/collection_test_mwe.docs", "./data/" , "./data/s-3.qrel", "./data/stopwords.large", "./data/w2v/glove.6B.300d.txt", "./", "./", 10, 10, 100 };

...
TEST(Euclidean_Distance_Equals_Test, Equals) {
    ...
    EXPECT_FLOAT_EQ(140.196289, calcEuclideanDistance(doc_a, doc_b));
}
...
TEST(Euclidean_Distance_Normalized_Equals_Test, Equals) {
    ...
    EXPECT_FLOAT_EQ(1.22768807, calcEuclideanDistanceNormalized(doc_a, doc_b));
}
...
TEST(Cosine_Similarity_Equals_Test, Equals) {
    ...
    EXPECT_FLOAT_EQ(0.246390939, calcCosineSimilarity(doc_a, doc_b));
}

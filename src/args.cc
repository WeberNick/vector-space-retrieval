...
void construct_arg_desc(argdesc_vt& x) {
    ...
    x.push_back(new sarg_t("--word-embeddings-path", "./data/", &Args::wordEmeddingsPath, "path to the data directory. relative path from repo root directory or absolute path possible"));

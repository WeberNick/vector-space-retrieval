...
class DocumentCollection {
 ...
 public:
  ...
  explicit DocumentCollection(const std::string& aRootDirectory);  // path to
                                                                   // root
                                                                   // directory
                                                                   // where the
                                                                   // collection
 ...
 public:
  /* start the scan for files at the root directory and add all found docs to
   * map */
  void collect();

 public:
  /* The following are just wrapper functions for the respective map container
   * calls */

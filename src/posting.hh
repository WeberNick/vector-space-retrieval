...
class Posting
{
    ...
    public:
        ...
        explicit Posting(const std::string& aTerm, const size_t_vt& aListOfIDs); //for bulk load
    ...
    public:
        /* add a document ID to the posting list. immediately sort or implement sort call?? */

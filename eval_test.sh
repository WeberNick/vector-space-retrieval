...
#echo "> [Eval] Tiered Index with tiers 50"
./bin/evsr_run --tiers 100 --collection-path ./testdata/d-collection.docs --query-path ./testdata/ --scores-path ./testdata/s-3.qrel --stopword-path ./testdata/stopwords.large --word-embeddings-path ./testdata/w2v/glove.6B.300d.txt --tiered

##### Evaluate different random projections dimensions ##### 
echo "> [Eval] Tier 50, Dim 1000"
./bin/evsr_run --tiers 50 --dimensions 1000 --collection-path ./testdata/d-collection.docs --query-path ./testdata/ --scores-path ./testdata/s-3.qrel --stopword-path ./testdata/stopwords.large --word-embeddings-path ./testdata/w2v/glove.6B.300d.txt

echo "> [Eval] Tier 50, Dim 1000"
./bin/evsr_run --tiers 50 --dimensions 2500 --collection-path ./testdata/d-collection.docs --query-path ./testdata/ --scores-path ./testdata/s-3.qrel --stopword-path ./testdata/stopwords.large --word-embeddings-path ./testdata/w2v/glove.6B.300d.txt

echo "> [Eval] Tier 100, Dim 1000"
./bin/evsr_run --tiers 100 --dimensions 1000 --collection-path ./testdata/d-collection.docs --query-path ./testdata/ --scores-path ./testdata/s-3.qrel --stopword-path ./testdata/stopwords.large --word-embeddings-path ./testdata/w2v/glove.6B.300d.txt

echo "> [Eval] Tier 100, Dim 2500"
./bin/evsr_run --tiers 1000 --dimensions 2500 --collection-path ./testdata/d-collection.docs --query-path ./testdata/ --scores-path ./testdata/s-3.qrel --stopword-path ./testdata/stopwords.large --word-embeddings-path ./testdata/w2v/glove.6B.300d.txt
